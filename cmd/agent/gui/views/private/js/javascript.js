...
function loadCheckConfigFiles() {
  ...
  function(data, status, xhr){
    ...
    data.forEach(function(item){
      ...
      $(".list").append(DOMPurify.sanitize('<a href="javascript:void(0)" onclick="showCheckConfig(\''
  ...
  function(data, status, xhr){
    ...
    function(data, status, xhr){
      ...
      data.forEach(function(item){
        ...
        $(".list").append(DOMPurify.sanitize('<a href="javascript:void(0)" onclick="addCheck(\'' +
  ...
  function(data, status, xhr){
    ...
    setTimeout(function(){
      ...
      if (data != "Success") {
        ...
        $('#general_status').html(DOMPurify.sanitize("<span class='center'>Error restarting agent: " + data + "</span>"));
